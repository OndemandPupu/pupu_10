...
#cart_layout_1 .cart_info .details .qty, #cart_layout_1 .cart_info .details .price,
...
<body>
	<div id="wrap">
		<div id="cart_layout_1">
			...
			<div class="cart_info">
				<div class="product">
					<img src="http://i.imgur.com/FWFeCsB.png" />
				</div>
				<div class="product_info">
					<div class="center">
						<span>product name</span><span>opt1</span><span>opt2</span>
					</div>
				</div>
				<div class="details">
					<div class="qty">
					...
					<div class="remove">
						<div class="center">
							<span class="hidden">Remove</span><i
								class="fa fa-times-circle fa-4"></i>
						</div>
					</div>
				</div>
			</div>
			<div class="complete_cart">
				<div class="updated">
					...
					<div class="coupon">
						<h2>Coupon Code</h2>
						<input id="code"></input> <a class="button update">Update Cart</a>
					</div>
				</div>
				<div class="checkout">
					<div class="total">
						<h2>Subtotal:</h2>
						<span class="sub"> <small>Excluding Tax and
								Shipping</small>
						</span>
					</div>
